<html>
    ...
    <body>
        <div class="header"> </div>
            <center>
            <a href="index.php"><button>List products</button></a>
...
mysqli_query($connect,"set character_set 'utf8'");
 ...
 while($row = mysqli_fetch_array($result)){
  ...
  <tr>
    ...
    <td>'.$row['e_price'].'</td>
    <td>'.$row['a_price'].'</td>
    <td><input type="text" name="ne_price"></td>
    <td><input type="text" name="na_price"></td>
...
?>
        ...
        <center><a href="index.php"><button>Show labels</button></a></center>
         <center><a href="updateall.php"><button>update all</button></a></center>
